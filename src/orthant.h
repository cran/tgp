...
/* We can use system's erf() if availabel (and faster).
...
#ifdef  __CYGWIN__
#define MAXM    16    /* maximum dimension size  */
#define MAXGRD  1025  /* maximum number of grid points */
#else
...
#define nrml_dn(X)  (exp(-0.5*(X)*(X)) * 0.39894228040143268)
