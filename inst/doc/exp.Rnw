...
\begin{figure}[ht!]
\centering
<<label=bgp,fig=TRUE,echo=TRUE,width=12.5,height=7.5,include=FALSE>>=
plot(exp.bgp, main='GP,')
@
<<echo=false,results=hide>>=
graphics.off()
@
\includegraphics[trim=0 35 0 25]{exp-bgp}
%\vspace{-0.5cm}
...
\begin{figure}[ht!]
\centering
<<label=btgp,fig=TRUE,echo=TRUE,width=12.5,height=7.5,include=FALSE>>=
plot(exp.btgp, main='treed GP,')
@
<<echo=false,results=hide>>=
graphics.off()
@
\includegraphics[trim=0 35 0 25]{exp-btgp}
%\vspace{-0.25cm}
<<label=btgptrees,fig=TRUE,echo=TRUE,width=6,height=5,include=FALSE>>=
tgp.trees(exp.btgp)
@
<<echo=false,results=hide>>=
graphics.off()
@
\includegraphics[trim=50 65 50 10]{exp-btgptrees}
\vspace{-0.5cm}
\caption{\footnotesize {\em Top-Left:} posterior predictive mean using
...
\cite{gra:lee:2006}. Also, Chipman et al.~recommend restarting 
...
\begin{figure}[ht!]
\centering
<<label=btgpllm,fig=TRUE,echo=TRUE,width=12.5,height=7.5,include=FALSE>>=
plot(exp.btgpllm, main='treed GP LLM,')
@
<<echo=false,results=hide>>=
graphics.off()
@
\includegraphics[trim=0 35 0 25]{exp-btgpllm}
%\vspace{-0.5cm}
\caption{\footnotesize {\em Left:} posterior predictive mean using
...
\begin{figure}[ht!]
\centering
<<label=1dbtgpllm1,fig=TRUE,echo=TRUE,width=12.5,height=7.5,include=FALSE>>=
...
@
\vspace{-0.65cm}
<<label=1dbtgpllm2,fig=TRUE,echo=TRUE,width=12.5,height=7.5,include=FALSE>>=
plot(exp.btgpllm, main='treed GP LLM,', proj=c(2))
@
<<echo=false,results=hide>>=
graphics.off()
@
\includegraphics[trim=0 10 0 25]{exp-1dbtgpllm1}
\includegraphics[trim=0 25 0 10]{exp-1dbtgpllm2}
%\vspace{-0.5cm}
...
by supplying a 1--vector {\tt proj} argument to the {\tt plot.tgp}.
