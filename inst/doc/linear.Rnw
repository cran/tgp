...
\begin{figure}[ht!]
\centering
<<label=blm,fig=TRUE,echo=TRUE,width=7,height=4.5,include=FALSE>>=
...
graphics.off()
@
\includegraphics[trim=0 25 0 25]{linear-blm}
%\vspace{-0.5cm}
...
\begin{figure}[ht!]
\centering
<<label=gplm,fig=TRUE,echo=TRUE,width=7,height=4.5,include=FALSE>>=
...
graphics.off()
@
\includegraphics[trim=0 25 0 25]{linear-gplm}
%\vspace{-0.5cm}
